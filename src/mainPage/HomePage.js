...
class HomePage extends Component {
 ...
 renderSideList() {
   return this.state.sideList.map((d, index) =>
     <li className="homeList" className={index === this.state.activeIndex ? 'homePageActiveList': ''}
      onClick={(e) => this.setSelect(index)} key={index}>
       <a href={d.id}><span>{d.text}</span></a>
     </li>
    )
 }
              ...
              <Grid bsClass='' id='yellowPanel' style={{ backgroundColor: '#FFD500' }}>
                <Row className="show-grid">
                  <div className='container' id='yellowPanelInner' style={{ padding: 0, margin: 40, transition: 'all .5s' }}>
                    <Col xs={6} md={4} sm={6} className='' style={{ position: 'relative' }}>
                      <img
                        style={{ minWidth: '100%', height: 'auto' }}
                        className=''
                        src={require("../assets/images/foodPic.jpg")}  alt="OSK logo" width="300" />
                    </Col>
                    <Col xs={6} md={4} sm={6} className=''>
            ...
            <div className='container'>
              ...
              <div id="allFood" className="bodyContainer" style={{ display: 'flex' }}>
                <div style={{ position: 'relative', width: '215px' }} >
                  <div className='homeSideBar' id="myScrollspy">
                ...
                <div className='cartEmptySection'>
